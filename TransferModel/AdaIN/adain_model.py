...
class AdaINModel(nn.Module):
    def __init__(self, encoder_path, decoder_path):
        ...
        # Chọn device nếu không có giá trị truyền vào
        ...
        # Chuyển mô hình sang đúng device
    ...
    def forward(self, content, style, alpha=1.0, interpolation_weights=None):
        ...
        # Chuyển các tensor đầu vào sang device
        ...
        if interpolation_weights:
            ...
            feat = torch.FloatTensor(1, C, H, W).zero_().to(self.device)  # Chuyển tensor này sang đúng device

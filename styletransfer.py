...
def style_Transfer(content_dir, style_dir, result_dir, model_names = ["AdaIN"]):
    models = load_model()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_names", type=lambda s: s.split(','), help="List of model names separated by commas")


    args = parser.parse_args()

    style_Transfer(args.content_dir, args.style_dir, args.result_dir, args.model_names)
